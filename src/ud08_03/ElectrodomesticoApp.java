...
public class ElectrodomesticoApp {
	...
	/**
	 * Recibe los valores de precioBase, color y peso El color por parámetro, y se
	 * comprueba que sea blanco,negro,rojo,azul o gris. Además no importa si el
	 * nombre esta escrito en mayúsculas o minúsculas la app lo detecta. 
	 * El consumo es un valor por defecto que la app genera aletoriamente entre A y F.
	 * 
	...
	/**
	 * Comprueba que el color pasado por parámetro corresponda a alguno de los que
